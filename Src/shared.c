...
bool checkCounter2 = false;
bool characterCounter = false;
bool characterCounter2 = false;
bool characterCounter3 = false;
int pacmanCounter = 2;
...
void shared_init(void) {
	...
	themeMusic = load_audio("Assets/Music/Naruto_theme.ogg");
	themeMusic2 = load_audio("Assets/Music/original_theme.ogg");
